...
for term in terms:
	...
	for everyis_a in category:
		dic[everyis_a.childNodes[0].data] += dic[ids.childNodes[0].data]
for term in terms:
	ids = term.getElementsByTagName('id')[0]
...
plt.boxplot(list, vert=True, whis=1, patch_artist=True, meanline=True, showbox= True, showcaps=True, showfliers=False,notch=False)
